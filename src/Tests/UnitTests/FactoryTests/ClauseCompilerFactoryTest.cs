...
public class ClauseCompilerFactoryTest
{
    ...
    [Fact]
    public void Compiler_Should_ProduceDoubleQuotedSql_When_CompilingFullQueryWithPostgresFactory()
    {
        // Arrange
    ...
    [Fact]
    public void Compiler_Should_ProduceBracketedSql_When_CompilingFullQueryWithSqlServerFactory()
    {
        // Arrange
    ...
    [Fact]
    public void Compiler_Should_ProduceBindingsMatchingSqlPlaceholders_When_CompilingFullQueryWithPostgresFactory()
    {
        // Arrange
        var sut = new Compiler(PostgresParameterFixer.Instance, new PostgresClauseCompilerFactory(), new SqlValidator());
        var query = new Query().Select("FirstName", "Age").From("Student").Where("Age", ">", 10).Where("IsMale", true);
